...
import { Menu, Bell, Sparkles, Palette, Hand, Heart, Crown } from "lucide-react";
  ...
  return (
    <div className="pb-32 min-h-screen" data-testid="home-screen">
      ...
      <div className="flex items-center justify-between px-5 pt-12 pb-2">
        <button data-testid="home-menu-btn" className="text-white">
          <Menu size={28} />
        </button>
        <button
          onClick={() => navigate("/admin")}
          data-testid="home-bell-btn"
          className="w-11 h-11 rounded-2xl bg-[#FF1493] flex items-center justify-center glow-pink-sm"
        >
      ...
      <div className="text-center mt-4 px-6">
        ...
        <h1 className="font-italic-display text-white text-4xl mt-2">
          ...
          {topServices.map((p, i) => (
            ...
            >
              <div className="h-28 overflow-hidden">
                <img
                  src={`https://images.unsplash.com/photo-${i % 2 === 0 ? '1604654894610-df63bc536371' : '1632345031435-8727f6897d53'}?q=80&w=400`}
                  className="w-full h-full object-cover"
                  alt={p.title}
                />
              </div>
